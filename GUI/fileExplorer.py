...
# Fix DLL loading on Windows when venv is based on Anaconda Python.
# Anaconda ships its own Qt5 DLLs which conflict with PySide6's Qt6 DLLs.
# This tells Windows to also search PySide6's folder for the correct DLLs.
try:
    import PySide6
